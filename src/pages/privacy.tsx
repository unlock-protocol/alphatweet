...
const PrivacyPage: NextPage = () => {
  return (
    <DefaultLayout>
      ...
      <h3>This Privacy Policy applies to information we collect:</h3>
      <p>On our via the Services.</p>
      <ul>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            website operated by Unlock or any third party; or any third party
            that may link to or be accessible from or via the Services.
          </p>
        </li>
      </ul>
      <p>
        ...
        employ, engage or manage. Please read this Privacy Policy carefully to
      ...
      <p>
        ...
        a child under 16, please contact us at hello@unlock-protocol.com.
      </p>
      <h2>What Personal Information does Unlock collect?</h2>
      <p>
      ...
      <p>
        Personal Information You Provide to Us: In order to use certain features
        of the Services, you must first connect your Ethereum wallet to the
        Services. We receive and may store any information you enter via the
        ...
        information (<strong>“Personal Information”</strong>) which may include
        your Ethereum address, name, physical or mailing address, email address,
        phone number, credit card and/or other payment information, IP address,
        browser information, use information, username, password, and any other
        information necessary for us to provide the Services.
      </p>
      <p>
        ...
        Unlock&apos;s products and services, including specials and new
        features.
      </p>
      ...
      <ul>
        <li>
          <p>
            ...
            interact with the Services. Unlock automatically receives and
        ...
        <li>
          <p>
            Generally, our service automatically collects usage information,
            such as the numbers and frequency of visitors to the Services and
            its components. We only uses this data in aggregate form, that is,
            as a statistical measure, and not in a manner that would identify
            you personally. This type of aggregate data enables us to figure out
            how often users use parts of Services so that we can make the
            Services appealing to as many users as possible, and improve those
            services. As part of this use of information, we may provide
            aggregate information to our partners about how our users,
            collectively, use the Services. We may share this type of
            statistical data so that our partners also understand how often
            people use the Services, so that they, too, may provide you with an
            optimal online experience. Again, Unlock never discloses aggregate
      ...
      <p>
        E-mail Communications: We often receive a confirmation when you open an
        email from Unlock if your computer supports this type of program. Unlock
        uses this confirmation to help us make emails more interesting and
        helpful. We also compare our user list to lists received from other
        companies, in an effort to avoid sending unnecessary messages to our
        users. When you receive e-mail from Unlock, you can opt out of receiving
      ...
      <ul>
        <li>
          <p>
            ...
            computer&apos;s hard drive through your browser to enable our
            systems to recognize your browser and tell us how and when pages in
            our site are visited and by how many people. Please note that we may
            use cookies to enhance visitors&apos; experiences, to learn more
            about their use of the Services and to improve quality.
          </p>
        </li>
        <li>
          <p>
            ...
            of ways. We strongly recommend that you leave the cookies activated,
            however, because cookies enable you to take advantage of some of the
            Services most attractive features.
          </p>
        </li>
      </ul>
      <h2>Will Unlock share any of the Personal Information it receives?</h2>
      <p>
      ...
      <p>
        <strong>Affiliated Businesses We Do Not Control</strong>: We anticipate
        that we may become affiliated with a variety of businesses and work
        closely with them. In certain situations, these businesses may sell
        items to you through the Services. In other situations, Unlock may
        provide services, or sell products jointly with affiliated businesses.
        You can easily recognize when an affiliated business is associated with
        your transaction, and we will share your Personal Information that is
        related to such transactions with that affiliated business.
      </p>
      <p>
        <strong>Contractors</strong>: We engage with other companies and
        individuals to perform tasks on our behalf and may need to share your
        information with them to provide products or services to you. Unless we
        tell you differently, Unlock&apos;s suppliers do not have any right to
        use your Personal Information we share with them beyond what is
        necessary to assist us. You hereby consent to our sharing of your
        Personal Information for the above purposes.
      </p>
      <p>
        <strong>User profiles</strong>: User profile information including
        users&apos; name, email address, and other information you enter (“User
        Submissions”) may be displayed to other users to facilitate user
        ...
        Submissions. Users&apos; email addresses will not be directly revealed
        to other users by Unlock, except, when the user is “connected” to
        another user via a shared group membership, or an invitation, or if the
        user has chosen to include their email address in their user profile.
      </p>
      <p>
        <strong>Communication in response to User Submissions</strong>: As part
        of the Services, you will receive from Unlock email and other
        communication relating to your User Submissions. You acknowledge and
        agree that by posting such User Submissions, Unlock may send you email
        and other communication that it determines in its sole discretion relate
        to your User Submissions.
      </p>
      <p>
        <strong>Promotional Offers</strong>: We may send offers to you on behalf
        of other businesses. However, when we do so, we do not give the other
      ...
      <p>
        <strong>Business Transfers</strong>: Unlock may go through a business
      ...
      <p>
        <strong>Protection of Unlock and Others</strong>: We may release
        Personal Information when we believe in good faith that release is
        necessary to comply with the law; enforce or apply our conditions of use
        and other agreements; or protect the rights, property, or safety of
        Unlock, our employees, our users, or others. This includes exchanging
        information with other companies and organizations for fraud protection
        and credit risk reduction. You acknowledge and consent to such
        disclosure.
      </p>
      <p>
        <strong>Compliance with the Agreement</strong>: We may use Personal
        Information to the extent it is required to enforce or apply our
        Agreement [INSERT AS LINK TO TERMS OF USE] and other agreements,
        including for billing and collection purposes.
      </p>
      <p>
        <strong>With Your Consent</strong>: Except as set forth above, you will
        be notified when your Personal Information may be shared with third
        parties, and will be able to prevent the sharing of this information.
      </p>
      <h2>Are there Risks with Transactions using Blockchain?</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>the amount of the cryptocurrency which you send or receive; or</p>
        </li>
        <li>
          <p>
      ...
      <p>
        A blockchain&apos;s records cannot be changed or deleted. This may
        affect your ability to exercise your rights such as your right to
        erasure (“right to be forgotten”), the right to rectification of your
        data or your rights to object or restrict processing of your Personal
      ...
      <p>
        You may also send us an email at hello@unlock-protocol.com to request
      ...
      <ul>
        <li>
          <p>
            If Unlock stores any of your account information, you will be able
            to add or update certain information on pages, such as those listed
            in the “What Personal Information can I access” section above. When
            you update information, however, we often maintain a copy of the
            unrevised information in our records.
          </p>
        </li>
        <li>
          <p>
            You may request deletion of your account information from our
            servers by sending an e-mail to hello@unlock-protocol.com. Please
            note that some information may remain in our records after deletion
            of your account. Re control any blockc information present on the
            Ethereum blockchain or other decentralized networks at any time.
            Your use of any blockchain technologies are at your own risk.
          </p>
        </li>
        <li>
          <p>
            If you do not wish to receive email or other mail from us, please
            indicate this preference during the registration process. Please
            note that if you do not want to receive legal notices from us, such
            as this Privacy Policy, those legal notices will still govern your
            use of the Services, and you are responsible for reviewing such
            legal notices for changes.
          </p>
        </li>
      </ul>
      <h2>Can Unlock make changes to this Privacy Policy?</h2>
      <p>
